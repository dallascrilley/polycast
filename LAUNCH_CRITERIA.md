...
| P0-4 | Sample commands (`uppercase`, `open-repo`) install via `apply --write` and run in PopClip + Raycast | B | missing — verification log required (`docs/verification/2026-06-14-core-path.md`) |
